...
-- Coin combo streak
GameData.COMBO_RESET_TIME   = 3.0
GameData.COMBO_THRESHOLDS   = { 1, 5, 10, 20 }
GameData.COMBO_MULTIPLIERS  = { 1,  2,  3,   5 }

-- Coin magnet pull speed (studs/s)
...
-- Biome depth ranges (in meters) - used for legacy/non-procedural contexts
...
-- Dynamic chunk constants
GameData.SLOT_DEPTH_METERS = 100
GameData.SLOT_DEPTH_STUDS  = GameData.SLOT_DEPTH_METERS * GameData.STUDS_PER_METER -- 320 studs
GameData.MAX_LOADED_SLOTS  = 3

-- Basket timing
GameData.BASKET_STEAM_TIME = 2.5
GameData.BASKET_DOOR_TIME  = 1.2

-- Mining nugget physics
GameData.NUGGET_GRAVITY      = 100
GameData.NUGGET_BOUNCE       = 0.45
GameData.NUGGET_MAGNET_MIN_T = 0.4

-- Flashlight
GameData.FLASHLIGHT_CONE_LEN = 38
GameData.FLASHLIGHT_ANGLE    = 35
