...
function DwarvenBasket.Build(levelFolder)
    ...
    for _, cx in ipairs({-1, 1}) do
        for _, cz in ipairs({-1, 1}) do
            PartBuilders.MakePart(basketModel, "BasketPost",
    ...
    PartBuilders.MakePart(basketModel, "BasketRimN", Vector3.new(0, rimY, -wallZ), Vector3.new(basketW, rimH, postW + 0.2), bronzeColor, steelMat)
    PartBuilders.MakePart(basketModel, "BasketRimS", Vector3.new(0, rimY,  wallZ), Vector3.new(basketW, rimH, postW + 0.2), bronzeColor, steelMat)
    PartBuilders.MakePart(basketModel, "BasketRimW", Vector3.new(-wallZ, rimY, 0), Vector3.new(postW + 0.2, rimH, basketW - postW * 2), bronzeColor, steelMat)
    PartBuilders.MakePart(basketModel, "BasketRimE", Vector3.new( wallZ, rimY, 0), Vector3.new(postW + 0.2, rimH, basketW - postW * 2), bronzeColor, steelMat)
